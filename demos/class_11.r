...
getwd()
#wd using r when it is looking for various objects --where does it look for something first
...
#absolute file path: goes from root directory to all the way to the file
#relative: relative to our current working directory, where our file is located
#default file path will be based on the location you first open it from
